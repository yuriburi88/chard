...
PROMPTS_MODULE_PATH = Path(__file__).resolve().parents[2] / "src" / "workflows" / "prompts.py"
PROMPTS_SPEC = importlib.util.spec_from_file_location("prompts_module", PROMPTS_MODULE_PATH)
        ...
        raw_records = [
            {
                ...
                "meta": {"title": "ETF inflows lift Bitcoin", "url": "https://example.com/bitcoin-etf"},
            },
            {
                "source": "rss",
                "timestamp": "2024-05-01T13:00:00Z",
                "text": "Ethereum staking continues to expand across DeFi platforms.",
                "meta": {"title": "Ethereum staking expansion", "url": "https://example.com/eth-staking"},
            },
        ]
        ...
        raw_records = [
            {
                ...
                "meta": {"title": "Solana ecosystem surge", "url": "https://example.com/solana-surge"},
            }
        ]
